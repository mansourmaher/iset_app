...

  {
    ...
    cell: ({ row }) => (
      <div className="flex space-x-2">
        <Link href={`/admin_workspace/formateurs/${row.original.id}`}>
          <Button
            variant={"green"}
...
interface DataTableDemoProps {
  users: Awaited<ReturnType<typeof getAllFormateurs>>;
}
    ...
    <div className="w-full">
      <div className="flex items-center py-4 justify-between">
        ...
        <Button
          variant={"primary"}
          size={"sm"}
          onClick={() => router.push("/admin_workspace/formateurs/add")}
        >
